		...
		if(pageValue.equalsIgnoreCase("execLogIn")) {
			...
			if (act.equals("update")) {
				...
				try {
					...
					String status = request.getParameter("customerUpdateStatus");
					String msg= request.getParameter("customerUpdateMsg");
...
//			}
			...
			try {
				...
				while(results.next()) {
					...
					session.setAttribute("custDeleteStatus", results.getString(4));		
