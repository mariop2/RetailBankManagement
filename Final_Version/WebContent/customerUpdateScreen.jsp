...
<br>
    ...
    <input type="text" placeholder="Enter Age" name="customerUpdateAge" id="cage" max="99" value = <%= session.getAttribute("CustomerUpdateAge") %>>
<br>
...
<br>
 ...
 <br>
    <button type = "submit" name = "regBtns" value = "update">Update</button>
